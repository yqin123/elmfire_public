...
INTEGER :: IX, IY
REAL :: FTP_PA, ANALYSIS_CELLSIZE_SQUARED, TOTAL_DFC, TOTAL_RADIATION, &
...
! CALL ELLIPSE_UCB(C) ! Call ellipse parameter calculation again. It is hard to assign values from 
...
! WRITE(*,*) C%IFBFM, C%WS20_NOW, C%ABSOLUTE_U,ELLIPSE_PARAMETERS%ELLIPSE_MAJOR,ELLIPSE_PARAMETERS%ELLIPSE_MINOR,ELLIPSE_PARAMETERS%ELLIPSE_ECCENTRICITY
...
HRR_TRANSIENT_MAP(IX,IY) = BURNING_NODES%HRR_TRANSIENT
WRITE(*,*) BURNING_NODES%IFBFM, BURNING_NODES%HRR_TRANSIENT
! *****************************************************************************
...
REAL :: DFC_COEFF, RAD_COEFF, ANALYSIS_CELLSIZE_SQUARED, RANALYSIS_CELLSIZE, HALF_ANALYSIS_CELLSIZE, HRR_ADJUSTER, ELLIPSE_MINOR_SQUARED, & 
        ...
        RAD_EFF_DIST, RAD_HEAT_RECEIVED
...
DO IX = IXTAGSTART, IXTAGSTOP
   ...
   TRANSIENT_DFC_WUI(IX,IY) = TOTAL_DFC_WUI(IX,IY) + DFC_HEAT_RECEIVED
   TRANSIENT_RADIATION_WUI(IX,IY) = TOTAL_RADIATION_WUI(IX,IY) + RAD_HEAT_RECEIVED

ENDDO
ENDDO

! Update the accumulated heat upto now
TOTAL_DFC_WUI(:,:) = TRANSIENT_DFC_WUI(:,:)*SIMULATION_DT*ANALYSIS_CELLSIZE_SQUARED
TOTAL_RADIATION_WUI(:,:) = TRANSIENT_RADIATION_WUI(:,:)*SIMULATION_DT*ANALYSIS_CELLSIZE_SQUARED
